...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.title.setTitle("MOMO API Example Store");
      ...
      if (event instanceof NavigationEnd) {
        switch (event.urlAfterRedirects) {
          case "/":
            this.meta.updateTag({
              name: "description",
              content: "Angular Example app Showcasing MTN MOMO API"
            });
            break;
          case "/" + AppConfig.routes.products:
            this.title.setTitle("Product list");
            this.meta.updateTag({
              name: "description",
              content: "List of Products On Sale"
            });
            break;
        }
      }
